        ...
        if yaml_config:
            ...
            if "asr" in yaml_config:
                ...
                config.asr = ASRConfig(
                    ...
                    offline=asr_data.get("offline", True),
                    benchmark_workers=asr_data.get("benchmark_workers", 1),
                    transcribe_timeout=asr_data.get("transcribe_timeout", 1800),
                    transcribe_max_retries=asr_data.get("transcribe_max_retries", 2),
                    batch_timeout=asr_data.get("batch_timeout", 3600),
                    batch_max_retries=asr_data.get("batch_max_retries", 1),
                    per_utterance_limit=asr_data.get("per_utterance_limit", 20),
