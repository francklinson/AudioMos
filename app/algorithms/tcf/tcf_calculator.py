...
sys.path.insert(0, os.path.join(os.path.dirname(os.path.abspath(__file__)), 'speechmetrics'))
sys.path.insert(0, os.path.join(os.path.dirname(os.path.abspath(__file__)), 'nisqa'))
sys.path.insert(0, os.path.join(os.path.dirname(os.path.abspath(__file__)), 'wenet'))
sys.path.insert(0, os.path.join(os.path.dirname(os.path.abspath(__file__)), 'scoreq'))
...
# 导入UTMOS
try:
    sys.path.insert(0, os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'utmos'))
...
try:
    sys.path.insert(0, os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'wenet'))
    import wenet
    if hasattr(wenet, 'load_model'):
        sys.path.insert(0, os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'wenet', 'wenet_local'))
        from wer import wer
