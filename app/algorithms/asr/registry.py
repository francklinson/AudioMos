...
ASR_ALGORITHM_DESCRIPTIONS = {
    ...
    "vibevoice-asr": {
        "display_name": "VibeVoice-ASR-7B (4-bit量化)",
        "description": "超低帧率分词器+LLM，单次处理60分钟长音频，4-bit在线量化，ICLR 2026 Oral",
        "architecture": "超低帧率分词器 + LLM (4-bit在线量化)",
        "params": "7B (4-bit ~8GB显存)",
        "cer_aishell1": "—",
        "streaming": False,
        "languages": ["zh", "en", "50+语言"],
        "license": "MIT",
        "preload": False,
        "tags": ["超长音频", "说话人分离", "ICLR", "4-bit"],
    },
}
