...
ASR_ALGORITHM_DESCRIPTIONS = {
    ...
    "firered-asr2": {
        ...
        "description": "中文ASR公开基准SOTA，支持20+方言和歌唱识别",
    ...
    "funasr-llm": {
        "display_name": "Fun-ASR-LLM (7.7B)",
        "description": "LLM-based ASR，集成VAD+ASR+Punc+说话人分离完整pipeline",
        "architecture": "LLM-based ASR",
        "params": "7.7B",
        "cer_aishell1": "~4.16%",
        "streaming": True,
        ...
        "license": "MIT",
        "preload": False,
        "tags": ["全功能", "LLM", "pipeline"],
    },
    "step-audio-2-mini": {
        "display_name": "Step-Audio-2-mini",
        "description": "端到端语音大模型，支持情感识别和语音原生工具调用",
        "architecture": "端到端语音大模型",
        "params": "8.32B",
        "cer_aishell1": "~3.19%",
        "streaming": True,
        "languages": ["zh", "en", "8种语言"],
        "license": "Apache 2.0",
        "preload": False,
        "tags": ["端到端", "情感识别", "大模型"],
    },
    "vibevoice-asr": {
        ...
        "description": "超低帧率分词器+LLM，单次处理60分钟长音频，ICLR 2026 Oral",
        "architecture": "超低帧率分词器 + LLM",
        "params": "7B",
        "cer_aishell1": "—",
        "streaming": False,
        "languages": ["zh", "en"],
