...
class MERTConfig:
    def __init__(self):
        ...
        self.MODEL_PATH = os.path.join(self.DRIVE_OUTPUT_DIR, 'finetuned_mert_model.pt')
        self.LABELMAP_PATH = os.path.join(self.DRIVE_OUTPUT_DIR, 'finetuned_mert_label_map.pkl')
...
class MERTTrainer:
    ...
    def train_epoch(self):
        ...
        for y1, y2, labels in self.train_loader:
    ...
    def train(self):
        ...
        print(f"Starting MERT fine-tuning for {self.config.EPOCHS} epochs...")
...
if __name__ == '__main__':
    ...
    evaluator = MERTEvaluator(config, trainer.model, trainer.feature_extractor)
