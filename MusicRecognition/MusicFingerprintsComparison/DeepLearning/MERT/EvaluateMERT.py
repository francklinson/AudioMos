...
class MERTConfig(BaseConfig):
    def __init__(self):
        super().__init__()

        self.model_path = 'MERT_Results/finetuned_mert_model.pt'
        self.labelmap_path = 'MERT_Results/finetuned_mert_label_map.pkl'
        ...
        self.output_dir = 'FINAL_ANALYSIS_RESULTS_MERT_NoAttention'
        self.sr = 24000
